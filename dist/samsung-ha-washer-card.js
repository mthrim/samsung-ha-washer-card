(()=>{var xt=Object.defineProperty;var v=(s,e)=>()=>(s&&(e=s(s=0)),e);var St=(s,e)=>{for(var t in e)xt(s,t,{get:e[t],enumerable:!0})};var q,Y,pe,De,U,Ie,D,He,ue,me=v(()=>{q=globalThis,Y=q.ShadowRoot&&(q.ShadyCSS===void 0||q.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,pe=Symbol(),De=new WeakMap,U=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==pe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Y&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=De.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&De.set(t,e))}return e}toString(){return this.cssText}},Ie=s=>new U(typeof s=="string"?s:s+"",void 0,pe),D=(s,...e)=>{let t=s.length===1?s[0]:e.reduce((i,o,r)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+s[r+1],s[0]);return new U(t,s,pe)},He=(s,e)=>{if(Y)s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),o=q.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,s.appendChild(i)}},ue=Y?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return Ie(t)})(s):s});var At,Et,Ct,kt,Tt,Nt,J,ze,Pt,Lt,I,ge,Be,Fe,$,Z=v(()=>{me();me();({is:At,defineProperty:Et,getOwnPropertyDescriptor:Ct,getOwnPropertyNames:kt,getOwnPropertySymbols:Tt,getPrototypeOf:Nt}=Object),J=globalThis,ze=J.trustedTypes,Pt=ze?ze.emptyScript:"",Lt=J.reactiveElementPolyfillSupport,I=(s,e)=>s,ge={toAttribute(s,e){switch(e){case Boolean:s=s?Pt:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Be=(s,e)=>!At(s,e),Fe={attribute:!0,type:String,converter:ge,reflect:!1,useDefault:!1,hasChanged:Be};Symbol.metadata??=Symbol("metadata"),J.litPropertyMetadata??=new WeakMap;$=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Fe){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Et(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){let{get:o,set:r}=Ct(this.prototype,e)??{get(){return this[t]},set(n){this[t]=n}};return{get:o,set(n){let l=o?.call(this);r?.call(this,n),this.requestUpdate(e,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Fe}static _$Ei(){if(this.hasOwnProperty(I("elementProperties")))return;let e=Nt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(I("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(I("properties"))){let t=this.properties,i=[...kt(t),...Tt(t)];for(let o of i)this.createProperty(o,t[o])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,o]of t)this.elementProperties.set(i,o)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let o=this._$Eu(t,i);o!==void 0&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let o of i)t.unshift(ue(o))}else e!==void 0&&t.push(ue(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return He(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,i);if(o!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:ge).toAttribute(t,i.type);this._$Em=e,r==null?this.removeAttribute(o):this.setAttribute(o,r),this._$Em=null}}_$AK(e,t){let i=this.constructor,o=i._$Eh.get(e);if(o!==void 0&&this._$Em!==o){let r=i.getPropertyOptions(o),n=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ge;this._$Em=o;let l=n.fromAttribute(t,r.type);this[o]=l??this._$Ej?.get(o)??l,this._$Em=null}}requestUpdate(e,t,i,o=!1,r){if(e!==void 0){let n=this.constructor;if(o===!1&&(r=this[e]),i??=n.getPropertyOptions(e),!((i.hasChanged??Be)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(n._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:o,wrapped:r},n){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),r!==!0||n!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),o===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[o,r]of this._$Ep)this[o]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[o,r]of i){let{wrapped:n}=r,l=this[o];n!==!0||this._$AL.has(o)||l===void 0||this.C(o,void 0,r,l)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};$.elementStyles=[],$.shadowRootOptions={mode:"open"},$[I("elementProperties")]=new Map,$[I("finalized")]=new Map,Lt?.({ReactiveElement:$}),(J.reactiveElementVersions??=[]).push("2.1.2")});function Xe(s,e){if(!xe(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ve!==void 0?Ve.createHTML(e):e}function T(s,e,t=s,i){if(e===C)return e;let o=i!==void 0?t._$Co?.[i]:t._$Cl,r=F(e)?void 0:e._$litDirective$;return o?.constructor!==r&&(o?._$AO?.(!1),r===void 0?o=void 0:(o=new r(s),o._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=o:t._$Cl=o),o!==void 0&&(e=T(s,o._$AS(s,e.values),o,i)),e}var we,je,Q,Ve,Je,w,Ze,Rt,E,z,F,xe,Mt,_e,H,We,Ge,S,Ke,qe,Qe,Se,u,Kt,qt,C,_,Ye,A,Ot,B,fe,j,N,be,ye,$e,ve,Ut,et,X=v(()=>{we=globalThis,je=s=>s,Q=we.trustedTypes,Ve=Q?Q.createPolicy("lit-html",{createHTML:s=>s}):void 0,Je="$lit$",w=`lit$${Math.random().toFixed(9).slice(2)}$`,Ze="?"+w,Rt=`<${Ze}>`,E=document,z=()=>E.createComment(""),F=s=>s===null||typeof s!="object"&&typeof s!="function",xe=Array.isArray,Mt=s=>xe(s)||typeof s?.[Symbol.iterator]=="function",_e=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,We=/-->/g,Ge=/>/g,S=RegExp(`>|${_e}(?:([^\\s"'>=/]+)(${_e}*=${_e}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ke=/'/g,qe=/"/g,Qe=/^(?:script|style|textarea|title)$/i,Se=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),u=Se(1),Kt=Se(2),qt=Se(3),C=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Ye=new WeakMap,A=E.createTreeWalker(E,129);Ot=(s,e)=>{let t=s.length-1,i=[],o,r=e===2?"<svg>":e===3?"<math>":"",n=H;for(let l=0;l<t;l++){let a=s[l],d,h,p=-1,m=0;for(;m<a.length&&(n.lastIndex=m,h=n.exec(a),h!==null);)m=n.lastIndex,n===H?h[1]==="!--"?n=We:h[1]!==void 0?n=Ge:h[2]!==void 0?(Qe.test(h[2])&&(o=RegExp("</"+h[2],"g")),n=S):h[3]!==void 0&&(n=S):n===S?h[0]===">"?(n=o??H,p=-1):h[1]===void 0?p=-2:(p=n.lastIndex-h[2].length,d=h[1],n=h[3]===void 0?S:h[3]==='"'?qe:Ke):n===qe||n===Ke?n=S:n===We||n===Ge?n=H:(n=S,o=void 0);let g=n===S&&s[l+1].startsWith("/>")?" ":"";r+=n===H?a+Rt:p>=0?(i.push(d),a.slice(0,p)+Je+a.slice(p)+w+g):a+w+(p===-2?l:g)}return[Xe(s,r+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},B=class s{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,n=0,l=e.length-1,a=this.parts,[d,h]=Ot(e,t);if(this.el=s.createElement(d,i),A.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(o=A.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(let p of o.getAttributeNames())if(p.endsWith(Je)){let m=h[n++],g=o.getAttribute(p).split(w),f=/([.?@])?(.*)/.exec(m);a.push({type:1,index:r,name:f[2],strings:g,ctor:f[1]==="."?be:f[1]==="?"?ye:f[1]==="@"?$e:N}),o.removeAttribute(p)}else p.startsWith(w)&&(a.push({type:6,index:r}),o.removeAttribute(p));if(Qe.test(o.tagName)){let p=o.textContent.split(w),m=p.length-1;if(m>0){o.textContent=Q?Q.emptyScript:"";for(let g=0;g<m;g++)o.append(p[g],z()),A.nextNode(),a.push({type:2,index:++r});o.append(p[m],z())}}}else if(o.nodeType===8)if(o.data===Ze)a.push({type:2,index:r});else{let p=-1;for(;(p=o.data.indexOf(w,p+1))!==-1;)a.push({type:7,index:r}),p+=w.length-1}r++}}static createElement(e,t){let i=E.createElement("template");return i.innerHTML=e,i}};fe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,o=(e?.creationScope??E).importNode(t,!0);A.currentNode=o;let r=A.nextNode(),n=0,l=0,a=i[0];for(;a!==void 0;){if(n===a.index){let d;a.type===2?d=new j(r,r.nextSibling,this,e):a.type===1?d=new a.ctor(r,a.name,a.strings,this,e):a.type===6&&(d=new ve(r,this,e)),this._$AV.push(d),a=i[++l]}n!==a?.index&&(r=A.nextNode(),n++)}return A.currentNode=E,o}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},j=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,o){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),F(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==C&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Mt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==_&&F(this._$AH)?this._$AA.nextSibling.data=e:this.T(E.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,o=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=B.createElement(Xe(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===o)this._$AH.p(t);else{let r=new fe(o,this),n=r.u(this.options);r.p(t),this.T(n),this._$AH=r}}_$AC(e){let t=Ye.get(e.strings);return t===void 0&&Ye.set(e.strings,t=new B(e)),t}k(e){xe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,o=0;for(let r of e)o===t.length?t.push(i=new s(this.O(z()),this.O(z()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=je(e).nextSibling;je(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},N=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,o,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}_$AI(e,t=this,i,o){let r=this.strings,n=!1;if(r===void 0)e=T(this,e,t,0),n=!F(e)||e!==this._$AH&&e!==C,n&&(this._$AH=e);else{let l=e,a,d;for(e=r[0],a=0;a<r.length-1;a++)d=T(this,l[i+a],t,a),d===C&&(d=this._$AH[a]),n||=!F(d)||d!==this._$AH[a],d===_?e=_:e!==_&&(e+=(d??"")+r[a+1]),this._$AH[a]=d}n&&!o&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},be=class extends N{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}},ye=class extends N{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==_)}},$e=class extends N{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??_)===C)return;let i=this._$AH,o=e===_&&i!==_||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==_&&(i===_||o);o&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ve=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}},Ut=we.litHtmlPolyfillSupport;Ut?.(B,j),(we.litHtmlVersions??=[]).push("3.3.2");et=(s,e,t)=>{let i=t?.renderBefore??e,o=i._$litPart$;if(o===void 0){let r=t?.renderBefore??null;i._$litPart$=o=new j(e.insertBefore(z(),r),r,void 0,t??{})}return o._$AI(s),o}});var Ae,y,Dt,tt=v(()=>{Z();Z();X();X();Ae=globalThis,y=class extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=et(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return C}};y._$litElement$=!0,y.finalized=!0,Ae.litElementHydrateSupport?.({LitElement:y});Dt=Ae.litElementPolyfillSupport;Dt?.({LitElement:y});(Ae.litElementVersions??=[]).push("4.2.2")});var it=v(()=>{});var Ee=v(()=>{Z();X();tt();it()});var st,P,c,V,ee,te=v(()=>{st="samsung-ha-washer-card",P={device_name:"washer",title:"Washer",show_subtitle:!0,layout_mode:"hero",show_completion_time:!0,show_status_chips:!0,show_child_lock:!0,show_power:!0,show_energy:!0,show_bubble_soak_control:!0,show_washer_settings:!0,show_drum_progress:!0,drum_progress_color:"#5b9cf6",finished_green_duration:60,completion_color_threshold_1:50,completion_color_threshold_2:30,icons:{appliance:"mdi:washing-machine",start:"mdi:play",pause:"mdi:pause",stop:"mdi:stop",child_lock:"mdi:lock",remote_control:"mdi:remote",bubble_soak:"mdi:water-circle",power:"mdi:flash",energy:"mdi:lightning-bolt",complete:"mdi:clock-outline",spin_level:"mdi:rotate-3d-variant",rinse_cycles:"mdi:water-sync",extra_detergent:"mdi:bottle-tonic"}},c={machineState:"machine_state",jobState:"job_state",completionTime:"completion_time",command:"command",childLock:"child_lock",remoteControl:"remote_control",bubbleSoak:"bubble_soak",spinLevel:"spin_level",rinseCycles:"rinse_cycles",extraDetergent:"extra_detergent",power:"power",cycleEnergy:"cycle_energy"},V={wash:"Washing",rinse:"Rinsing",spin:"Spinning",pre_wash:"Pre-Wash",delay_wash:"Delayed",finish:"Finished",none:"Idle",drying:"Drying",air_wash:"Air Wash",ai_wash:"AI Wash",ai_rinse:"AI Rinse",ai_spin:"AI Spin",cooling:"Cooling",weight_sensing:"Weight Sensing",wrinkle_prevent:"Wrinkle Prevention",freeze_protection:"Freeze Protection"},ee={run:"Running",pause:"Paused",stop:"Stopped"}});var mt={};St(mt,{SamsungHAWasherCardEditor:()=>oe});var It,Ht,zt,oe,Te=v(()=>{Ee();te();It=[{key:"machine_state_entity",label:"Machine State Entity"},{key:"job_state_entity",label:"Job State Entity"},{key:"completion_time_entity",label:"Completion Time Entity"},{key:"command_entity",label:"Command Entity"},{key:"child_lock_entity",label:"Child Lock Entity"},{key:"remote_control_entity",label:"Remote Control Entity"},{key:"bubble_soak_entity",label:"Bubble Soak Entity"},{key:"spin_level_entity",label:"Spin Level Entity"},{key:"rinse_cycles_entity",label:"Rinse Cycles Entity"},{key:"extra_detergent_entity",label:"Extra Detergent Entity"},{key:"power_entity",label:"Power Entity"},{key:"energy_entity",label:"Energy Entity"}],Ht=[{key:"show_subtitle",label:"Show subtitle"},{key:"show_completion_time",label:"Show completion time"},{key:"show_status_chips",label:"Show status chips"},{key:"show_child_lock",label:"Show child lock badge"},{key:"show_power",label:"Show power"},{key:"show_energy",label:"Show cycle energy"},{key:"show_bubble_soak_control",label:"Show bubble soak control"},{key:"show_washer_settings",label:"Show washer settings (spin, rinse, detergent)"},{key:"show_drum_progress",label:"Show drum progress fill"}],zt=[{key:"appliance",label:"Appliance Icon"},{key:"start",label:"Start Icon"},{key:"pause",label:"Pause Icon"},{key:"stop",label:"Stop Icon"},{key:"child_lock",label:"Child Lock Icon"},{key:"remote_control",label:"Remote Icon"},{key:"bubble_soak",label:"Bubble Soak Icon"},{key:"spin_level",label:"Spin Level Icon"},{key:"rinse_cycles",label:"Rinse Cycles Icon"},{key:"extra_detergent",label:"Extra Detergent Icon"},{key:"power",label:"Power Icon"},{key:"energy",label:"Energy Icon"},{key:"complete",label:"Completion Icon"}],oe=class extends y{static properties={hass:{},_config:{state:!0}};static styles=D`
    :host {
      display: block;
    }
  ...
  `;getStateFlags(e){return{isRunning:e==="run",isPaused:e==="pause",isStopped:e==="stop"}}renderChip(e,t,i){return u`
    ...
    `}render(){if(!this.hass||!this._config)return u``;let e=this._config,t=rt(e),i=W(this.hass,t[c.machineState]),o=i?i.state:void 0,r=k(this.hass,t[c.jobState]),n=k(this.hass,t[c.completionTime]),l=W(this.hass,t[c.power]),a=W(this.hass,t[c.cycleEnergy]),d=b(o);d?!this._cachedState&&!this._historyPending&&(this._historyPending=!0,this._fetchLastKnownState(t).then(O=>{O&&(this._cachedState=O),this._historyPending=!1,this.requestUpdate()})):this._cachedState={machineStateEntity:i,machineState:o,jobState:r,completion:n,powerState:l,energyState:a};let h=d&&this._cachedState?this._cachedState:null,p=h?h.machineStateEntity:i,m=h?h.machineState:o,g=h?h.jobState:r,f=h?h.completion:n,R=h?h.powerState:l,re=h?h.energyState:a,Pe=ie(this.hass,t[c.bubbleSoak]),ne=k(this.hass,t[c.spinLevel]),ae=k(this.hass,t[c.rinseCycles]),le=k(this.hass,t[c.extraDetergent]),{isRunning:ce,isPaused:Le,isStopped:x}=this.getStateFlags(m),G=ht(p,e.finished_green_duration),gt=x&&G?"Finished":x&&!G?"Stopped":nt(m,g),_t=x&&G?"Cycle complete":at(m,g),he=e.show_completion_time&&lt(m,f),ft=he?pt(R,f,e):null,bt=(()=>{if(!e.show_drum_progress||!ce&&!Le)return null;let O=Ce(R,f);if(O===null)return null;let vt=e.drum_progress_color||"#5b9cf6",wt=.1+(100-O)*.009,Ue=`background: ${vt}; transform: translate(-50%, -50%) scale(${wt});`;if(f){let K=(new Date(f).getTime()-Date.now())/6e4;if(K<=10&&K>0){let de;K>5?de=3:de=3-(5-K)/5*2.25,Ue+=` animation: pulse ${de}s ease-in-out infinite;`}}return Ue})(),Re=ie(this.hass,t[c.childLock]),M=ie(this.hass,t[c.remoteControl]),Me=R?ke(this.hass,R.state,R.attributes.unit_of_measurement):"",Oe=re?ke(this.hass,re.state,re.attributes.unit_of_measurement):"",yt=["drum",ce?"running":""].filter(Boolean).join(" "),$t=e.show_washer_settings&&(!b(ne)||!b(ae)||!b(le));return u`
      <ha-card class=${[G?"finished":"",d?"stale":""].filter(Boolean).join(" ")}>
        <div class="card">
          ${this.renderHeader(e,he,f,ft,d)}

          ${this.renderHero(e,gt,_t,he?dt(f):null,yt,bt)}

          ${e.show_status_chips?u`
                <div class="chips">
                  ${e.show_child_lock?this.renderChip(e.icons.child_lock,Re?"Child Lock On":"Child Lock Off",Re):""}
                  ${this.renderChip(e.icons.remote_control,M?"Remote Enabled":"Remote Disabled",M)}
                </div>
              `:""}
          ...
          <div class="controls">
            ...
            <button
              class="control-btn"
              ?disabled=${Le||x||!M}
              @click=${()=>se(this,t[c.command],"pause")}
            >
              Pause
            </button>
            <button
              class="control-btn"
              ?disabled=${x||!M}
              @click=${()=>se(this,t[c.command],"stop")}
            >
              Stop
            </button>
          </div>
          ...
          ${e.show_bubble_soak_control&&!x?u`
                <button
                  class="toggle-btn ${Pe?"active":""}"
                  @click=${()=>ut(this,t[c.bubbleSoak])}
                >
                  ${Pe?"Bubble Soak Enabled":"Enable Bubble Soak"}
                </button>
              `:""}

          ${$t&&!x?u`
                <div class="washer-settings">
                  ${b(ne)?"":this.renderMetric("Spin Level",L(ne),e.icons.spin_level)}
                  ${b(ae)?"":this.renderMetric("Rinse Cycles",ae,e.icons.rinse_cycles)}
                  ${b(le)?"":this.renderMetric("Detergent",L(le),e.icons.extra_detergent)}
                </div>
              `:""}
    ...
    `}};customElements.define(st,Ne);Te();window.customCards=window.customCards||[];window.customCards.push({type:"samsung-ha-washer-card",name:"Samsung HA Washer Card",description:"A SmartThings-based Samsung washer card for Home Assistant"});})();
